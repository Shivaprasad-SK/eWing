...
<section class="home-products">
   ...
   <form action="" method="post" class="swiper-slide slide">
      ...
      <i class="fas fa-volume-up speak-icon" title="Speak Product Name" data-product-name="<?= urlencode($fetch_product['name']); ?>" style="margin-top:50px;"></i>
